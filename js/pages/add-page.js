export const AddPage = {
        ...
        <div class="bg-white p-6 rounded-[2.5rem] muji-shadow space-y-6">
            ...
            <div class="space-y-5">
                ...
                <div v-if="form.type === '收款'" class="space-y-2">
                    <label class="text-[10px] text-gray-400 uppercase tracking-widest px-2">收款對象</label>
                    <div class="flex flex-wrap gap-2 px-2">
                ...
                <!-- [新增朋友輸入框] -->
                <div v-if="isAddingFriend" class="mx-2 bg-gray-50 p-3 rounded-2xl flex items-center space-x-2 animate-in slide-in-from-top-1">
                    <input type="text" v-model="newFriendName" placeholder="名字..." class="flex-grow bg-white p-2 rounded-xl text-xs outline-none">
                ...
                <!-- 支付方式 -->
                <div class="space-y-2">
                    <label class="text-[10px] text-gray-400 uppercase tracking-widest px-2">支付方式</label>
    ...
    methods: {
        ...
        triggerAddFriend(target) { this.addFriendTarget = target; this.isAddingFriend = true; },
        confirmAddFriend() {
            if (this.newFriendName) {
                ...
                else if (this.addFriendTarget === 'split') this.selectedFriends.push(this.newFriendName);
        ...
        prepareAndSubmit() {
            ...
            if (this.form.type === '支出') {
                ...
                this.form.personalShare = 0; // 收款不計入個人生活支出
            } else {
                debt = 0;
