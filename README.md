# 日日記 (Nichi-Nichi Log) - 交換留學生版 🇯🇵🇹🇼

**Nichi-Nichi Log** 是一款專為在日留學生設計的極簡記帳應用。結合了 MUJI 無印風格的視覺設計與交換學生特有的需求（如：日幣/台幣換算、代墊拆帳、旅行專案管理），幫助你在異國生活中輕鬆紀錄每一筆開銷與回憶。

---

## 🌟 核心特色
- **MUJI 極簡美學**：低飽和度、大留白，減少記帳的心理負擔。
- **針對性功能**：
